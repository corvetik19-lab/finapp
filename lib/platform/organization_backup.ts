...
export async function hasUserModeAccess(mode: AppMode): Promise<boolean> {
  ...
  // РџСЂРѕРІРµСЂСЏРµРј, РІРєР»СЋС‡РµРЅ Р»Рё СЂРµР¶РёРј РІ РѕСЂРіР°РЅРёР·Р°С†РёРё
  // Р­С‚Рѕ РѕРіСЂР°РЅРёС‡РµРЅРёРµ РґРµР№СЃС‚РІСѓРµС‚ РґР»СЏ РІСЃРµС… РљР РћРњР• СЃСѓРїРµСЂ-Р°РґРјРёРЅР°
