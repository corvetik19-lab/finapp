-- =====================================================================
-- ПРИМЕНЕНИЕ АВТОМАТИЧЕСКИХ ПЛАТЕЖЕЙ ПО КРЕДИТАМ
-- =====================================================================
-- Скопируйте весь этот файл в Supabase SQL Editor и нажмите RUN
-- Или откройте отдельно: 20251005_auto_create_loan_payments.sql
-- =====================================================================
...
-- ТЕСТОВЫЙ ЗАПУСК
-- =====================================================================
-- Раскомментируйте строку ниже, чтобы сразу проверить работу функции:
-- SELECT * FROM auto_create_loan_payments();

-- =====================================================================
-- ПРОВЕРКА РЕЗУЛЬТАТА
-- =====================================================================
-- Проверить созданные платежи можно запросом:
-- SELECT name, due_date, amount_minor / 100.0 as amount_rubles, description
