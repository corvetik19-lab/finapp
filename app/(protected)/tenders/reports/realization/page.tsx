...
import RealizationReportClient from '@/components/tenders/reports/RealizationReportClient';
...
export default async function RealizationReportPage() {
  ...
  const reportData = await getRealizationReportData({ companyId });

  return (
    <Suspense fallback={<LoadingState />}>
      <RealizationReportClient 
